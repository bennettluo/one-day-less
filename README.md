<h1>
  <img
    src="apps/web/public/one-day-less-logo.svg"
    alt="One Day Less logo"
    style="height: 1em; vertical-align: -0.15em; margin-right: 0.35em;"
  />
  One Day Less
</h1>
...
![One Day Less web home full page](apps/web/public/one-day-less.png)
